<?php
//--------------------------------------------------
//　「ROIS」v0.99.1～用テーマ「MONOR」設定ファイル
...
//テーマのバージョン
define('THEME_VER', "v0.99.11 lot.210829.1");
...
//レスのテンプレートファイル
define('RESFILE', "mono_res");

//お絵かきのテンプレートファイル
define('PAINTFILE', "mono_paint");

//動画再生のテンプレートファイル
define('ANIMEFILE', "mono_anime");

//投稿時のテンプレートファイル
define('PICFILE', "mono_picpost");

//カタログ、検索モードのテンプレートファイル
define('CATALOGFILE', "mono_catalog");

//管理モードのテンプレートファイル
define('ADMINFILE', "mono_admin");
